...
function Get-TargetResource
{
    ...
    try
    {
        ...
        $uri = (Get-M365DSCAzureManagementUri) + "/$($resourceGroupInstance.ResourceId)/providers/Microsoft.VerifiedId/authorities/$($VerifiedIdAuthorityId)?api-version=2024-01-26-preview"
...
function Set-TargetResource
{
    ...
    if ($FaceCheckEnabled)
    {
        ...
        $uri = (Get-M365DSCAzureManagementUri) + "/subscriptions/$($SubscriptionId)/resourceGroups/$($ResourceGroupName)/providers/Microsoft.VerifiedId/authorities/$($VerifiedIdAuthorityId)?api-version=2024-01-26-preview"
