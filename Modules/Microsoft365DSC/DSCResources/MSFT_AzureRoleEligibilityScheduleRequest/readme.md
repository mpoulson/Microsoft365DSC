...
Represents a request for a role eligibility for a principal through Azure Privileged Identity Management (PIM) for Azure resources. The role eligibility can be permanently eligible without an expiry date or temporarily eligible with an expiry date.
